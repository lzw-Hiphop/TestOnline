    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="test_info">考试信息</a></li>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <c:forEach var="testBean" items="${testBeans}">
                    <tr>
                        <td>${testBean.paperId}</td>
                        <td>${testBean.subjectName}</td>
                        <td>${testBean.paperName}</td>
                        <td><a href="testing?paperId=${testBean.paperId}">
                            <button type="button" class="btn btn-xs btn-success">开始考试</button>
                        </a></td>
                    </tr>
                </c:forEach>
                </tbody>
