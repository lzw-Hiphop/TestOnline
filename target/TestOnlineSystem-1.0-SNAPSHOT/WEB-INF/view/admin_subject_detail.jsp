...
<div class="container">
    <div class="jumbotron">
        ...
        <div class="subject-form">
            <form action="admin_subject_detail/update?subjectid=${subjectidtemp}" method="post">
                <h4><span>科目号：</span>${subjectidtemp}</h4>
                <h4><span>科目名：</span>
                    <input type="text" id="subjectname" name="subjectname" value="${subjectnametemp}" required>
                </h4>
